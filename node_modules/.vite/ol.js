...
var GeolocationError = function(_super) {
  __extends2(GeolocationError2, _super);
...
var Geolocation = function(_super) {
  __extends2(Geolocation2, _super);
...
var BaseVectorLayer = function(_super) {
  __extends5(BaseVectorLayer2, _super);
...
var CanvasBuilder = function(_super) {
  __extends6(CanvasBuilder2, _super);
...
var CanvasImageBuilder = function(_super) {
  __extends7(CanvasImageBuilder2, _super);
...
var CanvasLineStringBuilder = function(_super) {
  __extends8(CanvasLineStringBuilder2, _super);
...
var CanvasPolygonBuilder = function(_super) {
  __extends9(CanvasPolygonBuilder2, _super);
...
var CanvasTextBuilder = function(_super) {
  __extends10(CanvasTextBuilder2, _super);
...
var LayerRenderer = function(_super) {
  __extends11(LayerRenderer2, _super);
...
var RenderEvent = function(_super) {
  __extends12(RenderEvent2, _super);
...
var CanvasLayerRenderer = function(_super) {
  __extends13(CanvasLayerRenderer2, _super);
...
var Executor = function() {
  ...
  Executor2.prototype.execute_ = function(context, contextScale, transform, instructions, snapToPixel, opt_featureCallback, opt_hitExtent, opt_declutterTree) {
    ...
    if (this.pixelCoordinates_ && equals3(transform, this.renderedTransform_)) {
...
var CanvasImmediateRenderer = function(_super) {
  __extends14(CanvasImmediateRenderer2, _super);
...
var CanvasVectorLayerRenderer = function(_super) {
  __extends15(CanvasVectorLayerRenderer2, _super);
...
var VectorLayer = function(_super) {
  __extends16(VectorLayer2, _super);
...
var VectorSourceEvent = function(_super) {
  __extends18(VectorSourceEvent2, _super);
...
var VectorSource = function(_super) {
  __extends18(VectorSource2, _super);
...
var ImageCanvas = function(_super) {
  __extends20(ImageCanvas2, _super);
...
var MapRenderer = function(_super) {
  __extends23(MapRenderer2, _super);
...
var CompositeMapRenderer = function(_super) {
  __extends24(CompositeMapRenderer2, _super);
...
var GroupEvent = function(_super) {
  __extends25(GroupEvent2, _super);
...
var LayerGroup = function(_super) {
  __extends25(LayerGroup2, _super);
...
var MapBrowserEvent = function(_super) {
  __extends27(MapBrowserEvent2, _super);
...
var MapBrowserEventHandler = function(_super) {
  __extends28(MapBrowserEventHandler2, _super);
...
var PluggableMap = function(_super) {
  __extends31(PluggableMap2, _super);
  ...
  PluggableMap2.prototype.renderFrame_ = function(time) {
    ...
    if (frameState) {
      ...
      if (previousFrameState) {
        var moveStart = !this.previousExtent_ || !isEmpty2(this.previousExtent_) && !equals(frameState.extent, this.previousExtent_);
        if (moveStart) {
          this.dispatchEvent(new MapEvent_default(MapEventType_default.MOVESTART, this, previousFrameState));
          this.previousExtent_ = createOrUpdateEmpty(this.previousExtent_);
        }
      }
      var idle = this.previousExtent_ && !frameState.viewHints[ViewHint_default.ANIMATING] && !frameState.viewHints[ViewHint_default.INTERACTING] && !equals(frameState.extent, this.previousExtent_);
      if (idle) {
...
var Attribution = function(_super) {
  __extends33(Attribution2, _super);
...
var FullScreen = function(_super) {
  __extends36(FullScreen2, _super);
...
var MousePosition = function(_super) {
  __extends37(MousePosition2, _super);
...
var Overlay = function(_super) {
  ...
  Overlay2.prototype.setOffset = function(offset) {
    this.set(Property5.OFFSET, offset);
  };
...
var ControlledMap = function(_super) {
  __extends39(ControlledMap2, _super);
...
var OverviewMap = function(_super) {
  __extends39(OverviewMap2, _super);
...
var ZoomSlider = function(_super) {
  __extends41(ZoomSlider2, _super);
...
var ZoomToExtent = function(_super) {
  __extends42(ZoomToExtent2, _super);
...
var Interaction = function(_super) {
  __extends43(Interaction2, _super);
...
var DoubleClickZoom = function(_super) {
  __extends44(DoubleClickZoom2, _super);
...
var PointerInteraction = function(_super) {
  __extends45(PointerInteraction2, _super);
...
var DragRotate = function(_super) {
  __extends47(DragRotate2, _super);
...
var DragBoxEvent = function(_super) {
  __extends49(DragBoxEvent2, _super);
...
var KeyboardPan = function(_super) {
  __extends51(KeyboardPan2, _super);
...
var KeyboardZoom = function(_super) {
  __extends52(KeyboardZoom2, _super);
...
var MouseWheelZoom = function(_super) {
  __extends53(MouseWheelZoom2, _super);
...
var PinchRotate = function(_super) {
  __extends54(PinchRotate2, _super);
...
var DragAndDropEvent = function(_super) {
  __extends56(DragAndDropEvent2, _super);
...
var DragAndDrop = function(_super) {
  __extends56(DragAndDrop2, _super);
...
var DragRotateAndZoom = function(_super) {
  __extends57(DragRotateAndZoom2, _super);
...
var Draw = function(_super) {
  ...
  function Draw2(options) {
    ...
    _this.addChangeListener(Property_default2.ACTIVE, _this.updateState_);
    return _this;
  }
...
var ExtentEvent = function(_super) {
  __extends60(ExtentEvent2, _super);
...
var ModifyEvent = function(_super) {
  __extends61(ModifyEvent2, _super);
...
var SelectEvent = function(_super) {
  __extends62(SelectEvent2, _super);
...
var Snap = function(_super) {
  ...
  Snap2.prototype.snapTo = function(pixel, pixelCoordinate, map) {
    ...
    if (this.vertex_ && !this.edge_) {
      var pixel1 = map.getPixelFromCoordinate(closestSegment[0]);
      var pixel2 = map.getPixelFromCoordinate(closestSegment[1]);
      var squaredDist1 = squaredDistance(pixel, pixel1);
      var squaredDist2 = squaredDistance(pixel, pixel2);
      var dist = Math.sqrt(Math.min(squaredDist1, squaredDist2));
...
var TranslateEvent = function(_super) {
  __extends64(TranslateEvent2, _super);
...
var Translate = function(_super) {
  ...
  function Translate2(opt_options) {
    ...
    _this.addChangeListener(Property_default2.ACTIVE, _this.handleActiveChanged_);
    return _this;
  }
...
var VectorRenderTile = function(_super) {
  __extends67(VectorRenderTile2, _super);
...
var VectorTile = function(_super) {
  __extends68(VectorTile2, _super);
